...
v2
?class
x = c(1,2, 'a') #combining character into numeric
class(v2)
(v3 = c(TRUE, FALSE, TRUE))
class(v3)
V3a <- c(T,F,T) #TRUE - T, FALSE-F
(v4 = 100:200)
length(v4) #number of items in the vector
v4
v5 = seq(1,10,2)
...
(taxila = 100:105)
names(taxila)
names(taxila) = c('satya', 'sakshi', 'akash', 'pushpendra', 'tushar')
taxila
taxila[3]
taxila['akash']
